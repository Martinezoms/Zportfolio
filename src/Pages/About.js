      ...
      <div className="about-bg">
        ...
        <div className="py-3 px-10 ml-12 about flex flex-col pt-80 space-y-5">
          ...
          <div className="text-greyish flex flex-col space-y-5">
            <p>
              I am a software Engineer, passionate and determined to create simple,fuctional and interactive UI designs.
              I am very much focused in completing tasks assigned to me on or before time,mostly before time. like I
              said earlier on the main page of my portfolio, i am a team player, innovative, adaptive, blah blah blah. I
              know, I sound too serious. Well, that's because I am being formal!.
            </p>
            <p>
